...
function App() {
  ...
  var _useState13 = useState([]),
    ...
    publicProjects = _useState14[0],
    setPublicProjects = _useState14[1];
  var _useState15 = useState(8),
    _useState16 = _slicedToArray(_useState15, 2),
    publicCount = _useState16[0],
    setPublicCount = _useState16[1];
  var _useState17 = useState(8),
    _useState18 = _slicedToArray(_useState17, 2),
    showMyCount = _useState18[0],
    setShowMyCount = _useState18[1];
  var _useState19 = useState('characters'),
  ...
  function _startPlay() {
    _startPlay = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee5() {
      var project, chunks, preload, i, _i, src, nextIdx;
      return _regenerator().w(function (_context5) {
        while (1) switch (_context5.n) {
          ...
          case 1:
            ...
            preload = Math.min(5, chunks.length);
            i = 0;
          case 2:
            if (!(i < preload)) {
              _context5.n = 4;
  ...
  function renderHome() {
    ...
    }, /*#__PURE__*/React.createElement("h1", null, "VividNovel"), !username && /*#__PURE__*/React.createElement("button", {
      className: "login-btn",
      onClick: function onClick() {
        return location.href = 'login.html';
      }
    }, "\uB85C\uADF8\uC778")), /*#__PURE__*/React.createElement("section", {
      className: "my-projects"
    }, /*#__PURE__*/React.createElement("div", {
      className: "section-header"
    }, /*#__PURE__*/React.createElement("h2", null, "\uB0B4 \uD504\uB85C\uC81D\uD2B8"), /*#__PURE__*/React.createElement("button", {
  ...
  function renderUpload() {
    ...
    }, "\u2190 \uD648"), /*#__PURE__*/React.createElement("span", null, project === null || project === void 0 ? void 0 : project.name)), /*#__PURE__*/React.createElement("div", {
      className: "content"
  ...
  function renderSetup() {
    ...
    return /*#__PURE__*/React.createElement("div", {
    ...
    })), activeTab === 'backgrounds' && /*#__PURE__*/React.createElement("div", {
      className: "flex"
      ...
      className: "tab ".concat(activeTab === 'characters' ? 'active' : ''),
      onClick: function onClick() {
        return setActiveTab('characters');
      }
    }, "\uB4F1\uC7A5\uC778\uBB3C"), /*#__PURE__*/React.createElement("div", {
      className: "tab ".concat(activeTab === 'backgrounds' ? 'active' : ''),
      onClick: function onClick() {
        return setActiveTab('backgrounds');
      }
